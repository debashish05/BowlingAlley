...
public class ControlDeskView implements ActionListener, ControlDeskObserver {
	...
	private JButton addParty, finished, assign,qbutton;
	private JFrame win;
	...
	public ControlDeskView(ControlDesk controlDesk, int maxMembers) {
		...
		qbutton = new JButton("Query");
		JPanel queryPanel = new JPanel();
		queryPanel.setLayout(new FlowLayout());
		qbutton.addActionListener(this);
		queryPanel.add(qbutton);
		...
		while (it.hasNext()) {
			...
			curLane.laneSubscriber.subscribe(laneStat);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(qbutton)) {
			queryDBView queryview = new queryDBView(this);
		}
